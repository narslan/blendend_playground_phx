...
draw canvas_w, canvas_h do
  ...
  grad = radial_gradient canvas_w * 0.5, canvas_h * 0.3, 200,  
                         canvas_w * 0.5, canvas_h * 0.3, 0 do
  ...
  grad2 = linear_gradient canvas_w * 0.5, canvas_h * 0.4, canvas_w * 0.5 + canvas_w * 0.4, canvas_h * 0.4 + canvas_h * 0.4 do
